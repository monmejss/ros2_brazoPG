...
#ifndef ARLO_NN_CONTROLLER__SRV__DETAIL__EVALUATE_DRIVER__FUNCTIONS_H_
#define ARLO_NN_CONTROLLER__SRV__DETAIL__EVALUATE_DRIVER__FUNCTIONS_H_
 ...
 * calls
 * arlo_nn_controller__srv__EvaluateDriver_Request__init().
...
/**
 * It calls
 * arlo_nn_controller__srv__EvaluateDriver_Request__fini()
...
/**
 * It calls
 * arlo_nn_controller__srv__EvaluateDriver_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * arlo_nn_controller__srv__EvaluateDriver_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_arlo_nn_controller
...
/**
 * It calls
 * arlo_nn_controller__srv__EvaluateDriver_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_arlo_nn_controller
...
/**
 * It calls
 * arlo_nn_controller__srv__EvaluateDriver_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * arlo_nn_controller__srv__EvaluateDriver_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_arlo_nn_controller
...
/**
 * It calls
 * arlo_nn_controller__srv__EvaluateDriver_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_arlo_nn_controller
...
/**
 * It allocates the memory for the array and calls
 * arlo_nn_controller__srv__EvaluateDriver_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_arlo_nn_controller
...
/**
 * It calls
 * arlo_nn_controller__srv__EvaluateDriver_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARLO_NN_CONTROLLER__SRV__DETAIL__EVALUATE_DRIVER__FUNCTIONS_H_
